...
| 6 | [06-抢券热路径.md](06-抢券热路径.md) | 抢券请求为什么在 Redis 里就返回了 |
| 7 | [07-落库和消息.md](07-落库和消息.md) | 抢成功之后，事件怎样进 PostgreSQL 和 Kafka |
| 8 | [08-查询和回放.md](08-查询和回放.md) | 查询为什么不读 PostgreSQL，回放接口在哪 |
